...
<script type="text/JavaScript">
	...
	function check(){
		if(isEmpty(document.myForm.courseNo.value)){
			alert("课程编号不能为空！");
...
<div id="tabsJ">
  ...
  <div id="content" align="center"> 
     <div id="center">
	 <BR /><BR />
		<form name="myForm"  action="addCourseServlet" method="post" >
			<table width="800" align="center" cellpadding="0" cellspacing="0">
				<thead>
					<tr>
						<td width="70%"><h5>课程管理-->添加课程</h5></td>						
					</tr>					
				</thead>				
				<tr>
					<td colspan="2" width="100%">
						<table width="100%">
							<tbody>
							<tr>
								<td align="right">课程信息录入</td>
								<td>注：带<font color="red"> * </font>号的必须填写</td>
							</tr>
							<tr>
								<td align="right">课程编号:</td>
								<td><input id="courseNo" name="courseNo" /><font color="red"> * </font></td>
							</tr>
							<tr>
								<td align="right">课程名称:</td>
								<td><input id="courseName" name="courseName" /><font color="red"> * </font></td>
							</tr>
							<tr>
								<td align="right">学时:</td>
								<td><input id="studyTime" name="studyTime" /><font color="red"> * </font></td>
							</tr>
							<tr>
								<td align="right">学分:</td>
								<td><input id="grade" name="grade" /><font color="red"> * </font></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input id="term" name="term" /><font color="red"> * </font></td>
							</tr>
							</tbody>
							<tr>
