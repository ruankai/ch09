...
<div id="tabsJ">
  ...
  <div id="content" align="center"> 
     <div id="center">
	 <BR /><BR />
		<form action="updateClassServlet" method="post" name="myForm" >
			<table width="800" align="center" cellpadding="0" cellspacing="0">
				<thead>
					<tr>
						<td width="70%"><h5>班级管理-->班级信息查看/修改&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="listAllClassServlet">&nbsp;&nbsp;&nbsp;返回</a></h5></td>
				...
				<tr>
					<td colspan="2" width="100%">
						<table width="100%">
							<%
								ClassTbl classTbl=(ClassTbl)request.getAttribute("classTbl");
								if(classTbl!=null){
							%>
							<tbody>
							<tr>
								<td align="right">班级信息</td>
								<td>注：带<font color="red"> * </font>号的必须填写</td>
							</tr>
							<tr>
								<td align="right">班级编号:</td>
								<td><input disabled="disabled" name="classNo" value="<%=classTbl.getClassNo()%>"/><font color="red"> * </font></td>
							</tr>
							<tr>
								<td align="right">班级名称:</td>
								<td><input id="className" name="className"  value="<%=classTbl.getClassName()%>"/><font color="red"> * </font></td>
							</tr>
							<tr>
								<td align="right">所属学院:</td>
								<td><input id="college" name="college"  value="<%=classTbl.getCollege()%>"/><font color="red"> * </font></td>
							</tr>
							</tbody>						
							...
							<tr>
								<td align="center" colspan="2">
									<input type="hidden" name="classNo" value="<%=classTbl.getClassNo()%>" style="width:0;height:0" />
